...
CupertinoPageRoute resetPasswordScreenFeature(String phone) {
  return CupertinoPageRoute(
    builder: (context) =>
        ChangeNotifierProvider(create: (context) => ResetPasswordModel()..init(), child: _ResetPasswordScreen(phone)),
  );
}
